//! Execution types — session, graph, checkpoint, telemetry, and statistics.
...
/// Context for an execution — carries state through the constitutional pipeline.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// The execution graph for a session — nodes and directed edges.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// A checkpoint of execution state for recovery.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
