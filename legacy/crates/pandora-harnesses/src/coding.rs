    ...
    pub fn new() -> Self {
        Self {
            manifest: HarnessManifestBuilder::default()
                ...
                .description(
                    "Code review, audit, debt tracking, simplification — ponytail patterns",
                )
...
coding_gene!(
    CodeAuditGene,
    "code-audit",
    "Full repo audit — over-engineering, dead code, debt"
);
coding_gene!(
    CodeDebtGene,
    "code-debt",
    "Harvest all ponytail: comments into a debt register"
);
coding_gene!(
    CodeGainGene,
    "code-gain",
    "Scoreboard: measured impact of ponytail simplifications"
);
coding_gene!(
    CodeSimplifyGene,
    "code-simplify",
    "Simplify code — remove unnecessary abstraction"
);
coding_gene!(
    CodeHelpGene,
    "code-help",
    "Quick-reference card for all coding gene modes"
);
coding_gene!(
    CodeStyleGene,
    "code-style",
    "Enforce consistent idiomatic patterns (rust, go, python, ts)"
);
coding_gene!(
    CodeRefactorGene,
    "code-refactor",
    "Extract method, inline variable, rename — safe refactors"
);
coding_gene!(
    CodeTestGene,
    "code-test",
    "Generate tests for untested paths (TDD: RED-GREEN-REFACTOR)"
);
coding_gene!(
    CodeSpikeGene,
    "code-spike",
...
mod tests {
    ...
    fn gene_count() {
        let genes: [&dyn Gene; 10] = [
            ...
            &CodeDebtGene::new(),
            &CodeGainGene::new(),
            &CodeSimplifyGene::new(),
            &CodeHelpGene::new(),
            &CodeStyleGene::new(),
            &CodeRefactorGene::new(),
            &CodeTestGene::new(),
            &CodeSpikeGene::new(),
        ];
    ...
    #[test]
    fn coding_domain() {
        assert_eq!(CodingDomainHarness::new().manifest().id, "coding-domain");
    }
}
