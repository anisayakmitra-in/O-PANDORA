//! Self-Healing Runtime Types.
//!
//! Detects failures and orchestrates automatic recovery.
//! No business logic. Runtime orchestration only.
...
/// A self-healing session tracks failures and
/// recovery actions for an execution.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
