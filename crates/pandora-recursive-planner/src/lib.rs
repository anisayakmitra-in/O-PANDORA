//! Pandora Recursive Planner — extracted from pandora-runtime (Phase 1A).
//!
...
impl RecursivePlanningEngine {
    pub fn generate(objective: &PlanningObjective, depth: usize) -> RecursivePlan {
        println!("[PLANNER] objective={}", objective.objective);
        ...
        for stage in 0..depth {
            ...
            let gain = objective.priority * (1.0 - (stage as f64 * 0.08));

            println!("[PLANNER] stage={} action={}", stage + 1, action);
